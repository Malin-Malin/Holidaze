  ...
  return (
    <div className="flex flex-row items-end gap-2 w-full">
      <div className="flex flex-row items-center gap-1 w-full sm:w-auto">
        <label htmlFor="sort-field" className="text-sm text-[var(--text-h)]/80">
          Sort by:
        </label>
        <select
          id="sort-field"
          ...
          className="w-full sm:w-auto rounded border border-[var(--color-honey)] px-3 py-2 text-sm bg-white dark:bg-[var(--bg)] focus:outline-none focus:ring-2 focus:ring-white appearance-none [&::-ms-expand]:hidden"
        >
